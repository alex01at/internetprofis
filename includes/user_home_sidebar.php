...
<div class="card mb-3 welcome-box card-glass"><!-- card rounded-0 mb-3 welcome-box Starts -->
	<div class="card-body pb-2"><!-- card-body Starts -->
		<center>
		<?php if(!empty($seller_image)){ ?>
		<img src="<?= $seller_image; ?>" class="img-fluid rounded-circle mb-3" width="100">
		<?php }else{ ?>
		<img src="<?= $site_url; ?>/user_images/empty-image.png"  class="img-fluid rounded-circle mb-3" width="100">
		<?php } ?>
		</center>
...
<div class="mb-3 carosel_sec carosel_sec_glass">
...
<div class="mb-3 carosel_sec mt-3 carosel_sec_glass">
...
<div class="card sticky-start mb-3 card_user card-glass">
	<div class="card-body">
