...
// Deaktiviert nur die Deprecated-Meldungen, zeigt aber echte Fehler weiterhin an
...
if($row_bar) {
    // Nur wenn ein Datensatz gefunden wurde, Variablen füllen
    ...
    // Standardwerte setzen, damit das Skript nicht abstürzt
    $enable_bar = "off";
    $bar_text = "";
    $bg_color = "#000";
    $text_color = "#fff";
