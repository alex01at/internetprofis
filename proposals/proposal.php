...
<script type="text/javascript" src="../../js/addthis_widget.js#pubid=ra-5a39d50ac9681a6c"></script>
...
<div id="report-modal" class="modal fade"><!-- report-modal modal fade Starts -->
	...
	<div class="modal-content"><!-- modal-content Starts -->
		<div class="modal-header p-2 pl-3 pr-3"><!-- modal-header Starts -->
			<?=$lang["report_proposal"]; ?><button class="close" data-dismiss="modal"><span>&times;</span></button>
		</div><!-- modal-header Ends -->
		<div class="modal-body"><!-- modal-body p-0 Starts -->
			<h6><?= $lang["report_proposal_desc"]; ?></h6>
			<form action="" method="post">
			<div class="form-group mt-3"><!--- form-group Starts --->
			<select class="form-control float-right" name="reason" required="">
			<option value=""><?=$lang["select"]; ?></option>
			<option><?= $lang["non_original_Content"];?></option>
			<option><?= $lang["inappropriate_proposal"];?></option>
			<option><?=$lang["trademark_violation"] ;?></option>
			<option><?=$lang["copyrights_violation"];?></option>
			<option><?=$lang["other"];?>
			</select>
			</div><!--- form-group Ends --->
			<br>
