          	...
          	<div class="tab-body p-3 pb-0 collapse" id="faq-<?= $id; ?>" data-parent="#faqTabs">
                  <form action="" method="post" class="edit-faq">
                        ...
                        <div class="form-group mb-0">
                              <a href="#" class="btn btn-danger btn-sm delete-faq"><?=$lang['th']['delete'];?></a>
...
<div class="tab"><!-- tab rounded Starts -->
      <div class="tab-body rounded border-1 p-3 pb-0 collapse" id="insert-faq" data-parent="#faqTabs">
            <form action="" method="post" class="add-faq">
                  <div class="form-group mb-2">
                        <input type="text" name="title" placeholder="<?=$lang['label']['headline'];?>" class="form-control form-control-sm" required>
                  </div>
                  <div class="form-group mb-2">
                        <textarea name="content" rows="3" placeholder="<?=$lang['content'];?>" class="form-control form-control-sm"></textarea>
                  </div>
                  <div class="form-group mb-0">
                        <button type="submit" class="btn btn-success btn-sm float-right"><?=$lang['save'];?></button>
                        <div class="clearfix"></div>
