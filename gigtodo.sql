...
CREATE TABLE `admins` (
  ...
  `login_time` int(11) NOT NULL DEFAULT 3600,
...
INSERT INTO colors (section, color) VALUES 
('menu_bar_color', '#333333'),
('footer_color', '#333333'),
('post_footer_color', '#333333'),
('header_color', '#333333'),
('navbar_color', '#333333');
...
CREATE TABLE `general_settings` (
  ...
  `enable_copyright` text COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `menu_bar_color` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `site_theme` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `footer_color` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
