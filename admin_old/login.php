        ...
        <div class="container">
          ...
          <?php if(isset($_GET['session_expired'])){ ?>
            ...
            <?php } ?>
                ...
                <input type="password" class="pass form-control" value="<?php if(isset($_SESSION["r_password"])) { echo $_SESSION["r_password"]; }else{ echo " "; } ?>"  name="admin_pass" >
