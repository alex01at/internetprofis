...
if((time() - $_SESSION['loggedin_time']) > 980000){
...
<body>
  ...
  <div id="right-panel" class="right-panel">
	...
	<!-- Header-->
	<header id="header" class="header"><a href="../admin/index?dashboard" class="btn-danger" style="position: absolute;">New Admincenter</a>
