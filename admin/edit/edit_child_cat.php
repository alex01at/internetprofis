...
if(isset($_GET['edit_child_cat'])){
    ...
    $get_meta = $db->select("child_cats_meta",array("child_id" => $child_id,"language_id" => 1));
    $row_meta = $get_meta->fetch();
    $default_child_title = $row_meta->child_title;
    $default_child_desc = $row_meta->child_desc;
    $get_meta = $db->select("cats_meta",array("cat_id" => $child_parent_id, "language_id" => 1));
    $row_meta = $get_meta->fetch();
    $default_cat_title = $row_meta->cat_title;
                ...
                <div class="card-header">
                    ...
                    <div class="float-right">
                        <div class="page-title">
                            ...
                            <li class="active"><a href="javascript:history.back()" class="btn btn-danger">
                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <?php if ($adminLanguage != 1) { ?>
                            <div class="col-md-4">
                                Mainlanguage: <span class="text-danger"><?=$default_child_title?></span>
                            </div>
                            <?php } ?>
                        </div>
                        <!--- form-group row Ends --->
                        <div class="form-group row">
                            ...
                            <?php if ($adminLanguage != 1) { ?>
                            <div class="col-md-4">
                                Mainlanguage: <span class="text-danger"><?=$default_child_desc?></span>
                            </div>
                            <?php } ?>
                        </div>
                        <!--- form-group row Ends --->
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <select name="parent_cat" class="form-control" required>
                                    ...
                                    $get_meta = $db->select("cats_meta",array("cat_id" => $cat_id, "language_id" => 1));
                            ...
                            <?php if ($adminLanguage != 1) { ?>
                            <div class="col-md-4">
                                Suggestion: <span class="text-danger"><?=$default_cat_title?></span>
                            </div>
                            <?php } ?>
                        </div>
                        <!--- form-group row Ends --->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="submit" name="update_child_cat" value="Update Sub Category"
...
if(isset($_POST['update_child_cat'])){
    ...
    if($val->run() == false){
        ...
        if($update_child_cat){
            ...
            echo "<script>window.open('index?children','_self');</script>";
        }
    }
}
?>
