                ...
                <div class="card-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" disabled="" name="title" class="form-control" value="<?= $title; ?>"
                                    required>
                                <small><span class="text-danger">! Important</span> Language Title Can Not Be Changed
                                    After Adding.</small>
                            </div>
                        </div>
                        <!--- form-group row Ends --->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="submit" name="update_language" class="btn btn-success form-control"
