                ...
                <div class="card-header">
                    ...
                    <div class="float-right">
                        <div class="page-title">
                            <ol class="text-right">
                                <a href="index?view_coupons" class="btn btn-danger">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="coupon_price" class="form-control"
                                        value="<?= $coupon_price; ?>" min="1" required>
                                    <?php }else{ ?>
                                    <span class="input-group-addon">
                                        <b>%</b>
                                    </span>
