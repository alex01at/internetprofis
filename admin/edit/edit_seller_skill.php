                ...
                <div class="card-header">
                    ...
                    <div class="float-right">
                        <div class="page-title">
                            <ol class="text-right">
                                <a href="index?view_seller_skills" class="btn btn-danger">
                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="skill_title" class="form-control" value="<?= $skill_title; ?>"
                                    required>
                            </div>
                        </div>
                        <!--- form-group row Ends --->
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="submit" name="update_seller_skill" class="btn btn-success form-control"
                                    value="Update Skill">
                            </div>
                        </div>
                        <!--- form-group row Ends --->
