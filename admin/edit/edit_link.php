                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                            ...
                            <div class="col-md-6">
                                ...
                                <small>
                                    <a target="_blank" href="https://fontawesome.com/v4.7.0/icons/"
                                        class="btn-link">Click Here</a> To View All Font Awesome Icons Class Names.
                                    “Example of sample code: fa-comments
                                </small>
                            </div>
                        </div>
                        <!--- form-group row Ends --->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="submit" name="update_link" value="Update Link"
