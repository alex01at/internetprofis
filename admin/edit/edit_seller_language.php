                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="language_title" class="form-control"
                                    value="<?= $language_title; ?>" required>
                            </div>
                        </div>
                        <!--- form-group row Ends --->
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="submit" name="update_seller_language" class="btn btn-success form-control"
