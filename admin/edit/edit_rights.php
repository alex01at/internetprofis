...
$get_admin_info = $db->select("admins", array("admin_id" => $admin_id));
    $row_admin_info = $get_admin_info->fetch();
    ...
    <div class="col-lg-12">
      ...
      <div class="card">
        ...
        <div class="card-header">
          <!--- card-header Starts --->
          <ol class="text-right">
            <a href="index?view_users" class="btn btn-danger">
        ...
        <div class="card-body">
          ...
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
              ...
              <label class="col-md-3 control-label"> Admin Rights for <?= $admin_name?> : </label>
              <div class="row">
              <div class="col-md-4 bg-white">
                <div class="checkbox">
                  <label><input type="checkbox" name="settings" <?php if($a_settings == 1){ echo "checked"; } ?>
                      value="1">Settings</label>
                </div>
                <div class="checkbox">
                  <label><input type="checkbox" name="plugins" <?php if($a_plugins == 1){ echo "checked"; } ?>
                      value="1">Plugins</label>
                </div>
                <div class="checkbox">
                  <label><input type="checkbox" name="pages" <?php if($a_pages == 1){ echo "checked"; } ?>
                      value="1">Pages</label>
                </div>
                <div class="checkbox">
                  <label><input type="checkbox" name="video_schedules"
                      <?php if($a_video_schedules == 1){ echo "checked"; } ?> value="1">Video Schedules</label>
                </div>
                <div class="checkbox">
                  <label><input type="checkbox" name="blog" <?php if($a_blog == 1){ echo "checked"; } ?>
                      value="1">Blog</label>
                </div>
                <div class="checkbox">
                  <label><input type="checkbox" name="proposals" <?php if($a_proposals == 1){ echo "checked"; } ?>
                      value="1">Proposals</label>
                </div>
                <div class="checkbox">
                  <label><input type="checkbox" name="accounting" <?php if($a_accounting == 1){ echo "checked"; } ?>
                      value="1">Accounting</label>
                </div>
                <div class="checkbox">
                  <label><input type="checkbox" name="payouts" <?php if($a_payouts == 1){ echo "checked"; } ?>
                      value="1">Payouts</label>
                </div>
                <div class="checkbox">
                  <label><input type="checkbox" name="inbox" <?php if($a_inbox == 1){ echo "checked"; } ?>
                      value="1">Inbox Conversations</label>
                </div>
              </div>
              <div class="col-md-4 bg-white">
                <div class="checkbox">
                ...
                <div class="checkbox">
                  <label><input type="checkbox" name="reports" <?php if($a_reports == 1){ echo "checked"; } ?>
                      value="1">Reports</label>
                </div>
                <div class="checkbox">
                  <label><input type="checkbox" name="reviews" <?php if($a_reviews == 1){ echo "checked"; } ?>
                      value="1">Reviews</label>
                </div>
                <div class="checkbox">
                  <label><input type="checkbox" name="buyer_requests"
                      <?php if($a_buyer_requests == 1){ echo "checked"; } ?> value="1">Buyer Requests</label>
                </div>
                <div class="checkbox">
                ...
                <div class="checkbox">
                  <label><input type="checkbox" name="delivery_times"
                      <?php if($a_delivery_times == 1){ echo "checked"; } ?> value="1">Delivery Times</label>
                </div>
                <div class="checkbox">
                  <label><input type="checkbox" name="seller_languages"
                      <?php if($a_seller_languages == 1){ echo "checked"; } ?> value="1">Seller Languages</label>
                </div>
                <div class="checkbox">
                  <label><input type="checkbox" name="seller_skills"
                      <?php if($a_seller_skills == 1){ echo "checked"; } ?> value="1">Seller Skills</label>
                </div>
                <div class="checkbox">
                  <label>
                    <input type="checkbox" name="customer_support"
                      <?php if($a_customer_support == 1){ echo "checked"; } ?> value="1">Customer Support
                  </label>
                </div>
              </div>
              <div class="col-md-4 bg-white">
                <div class="checkbox">
                  <label>
                    <input type="checkbox" name="coupons" <?php if($a_coupons == 1){ echo "checked"; } ?>
                      value="1">Coupons
                  </label>
                </div>
                <div class="checkbox">
                ...
                <div class="checkbox">
                  <label>
                    <input type="checkbox" name="sellers" <?php if($a_coupons == 1){ echo "checked"; } ?>
                      value="1">Sellers
                  </label>
                </div>
                <div class="checkbox">
                ...
                <div class="checkbox">
                  <label>
                    <input type="checkbox" name="referrals" <?php if($a_referrals == 1){ echo "checked"; } ?>
                      value="1">Referrrals
                  </label>
                </div>
                <div class="checkbox">
                ...
                <div class="checkbox">
                  <label>
                    <input type="checkbox" name="knowledge_bank" <?php if($a_knowledge_bank == 1){ echo "checked"; } ?>
                      value="1">Knowledge Bank
                  </label>
                </div>
                <div class="checkbox">
                  <label>
                    <input type="checkbox" name="languages" <?php if($a_languages == 1){ echo "checked"; } ?>
                      value="1">Languages
                  </label>
                </div>
              </div>
