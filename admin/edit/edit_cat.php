...
$get_default_language_meta = $db->select("cats_meta", array("cat_id" => $edit_id, "language_id" => 1));
        ...
        <div class="col-lg-12">
         ...
         ?>
                ...
                <div class="card-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                Mainlanguage: <?=$default_cat_title?>
                            </div>
                            <?php } ?>
                        </div>
                        <!--- form-group row Ends --->
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <textarea name="cat_desc" rows="10" required="" style="width: 100%;"><?= $c_desc; ?></textarea>
                            </div>
                            <?php if ($adminLanguage != 1) { ?>
                            <div class="col-md-4">
                                Mainlanguage:<br>
            ...
            ?>>
                        ...
                        <div class="form-group row">
                            <!--- form-group row Starts --->
                            <label class="col-md-3 control-label"> Enable Watermark : </label>
                            <div class="col-md-5">
