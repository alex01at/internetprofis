                ...
                <div class="card-header">
                    <div class="float-right">
                        <div class="page-title">
                            <ol class="text-right">
                                <a href="index?view_terms" class="btn btn-danger">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                ...
                                <br>
                                <small class="text-muted p">If you enter html mode, remember to turn it off before
                                    saving or updating.</small>
                            </div>
                            <div class="col-md-6">
                                <textarea class="form-control" name="term_description" rows="7"
                                    required><?= $term_description; ?></textarea>
                            </div>
                        </div>
                        <!--- form-group row Ends --->
                        <div class="form-group row">
