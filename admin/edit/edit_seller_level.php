...
// Wenn die gewünschte Sprache keine Übersetzung hat, Daten von Sprache ID 1 verwenden
if ($adminLanguage != 1 && !$level_meta) {
                ...
                <div class="card-header">
                    ...
                    <div class="float-right">
                        <div class="page-title">
                            <ol class="text-right">
                                <a href="index?view_seller_levels" class="btn btn-danger">
                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="level_title" class="form-control" value="<?= $level_title; ?>"
                                    required>
                                    <?php 
        if ($adminLanguage != 1 && $count_meta != 1) {
            echo ' <span class="text-danger">(Translation needed: ' . $level_title . ')</span>';
        } ?>
                            </div>
                        </div>
                        <!--- form-group row Ends --->
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="submit" name="update_seller_level" class="btn btn-success form-control"
                                    value="Update Seller Level">
                            </div>
                        </div>
                        <!--- form-group row Ends --->
                    </form>
