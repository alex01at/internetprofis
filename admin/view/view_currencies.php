   ...
   <div class="row">
      ...
      <div class="col-lg-12">
         ...
         <div class="alert alert-info mt-3">
            <i class="fa fa-info-circle"></i> Make sure to configure the currency converter in <a
               href="index?api_settings" class="text-success">Settings/Api Settings page.</a>
         </div>
         <div class="card">
            <!--- card Starts --->
            ...
            <div class="card-body">
               ...
               <table class="table table-bordered table-striped">
                  <!--- table table-bordered table-striped Starts -->
                  <thead>
                     <tr>
                        <th>No</th>
                        <th>Name</th>
               ...
               ?>
                  ...
                  <i class="fa fa-fw fa-cog"></i> Settings
                           ...
                           <a class="btn text-white btn-danger" href="index?delete_currency=<?= $id; ?>"
