                ...
                <div class="card-header">
                    ...
                    <ol class="text-right">
                        <li class="active"><a href="index?insert_delivery_time" class="btn btn-success">
                                <i class="fa fa-plus-circle text-white"></i> <span class="text-white">Add Delivery
                                    Time</span>
                            </a></li>
                    </ol>
                    <h4 class="h4">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="index?delete_delivery_time=<?= $delivery_id; ?>"
                                            onclick="return confirm('Do you really want to delete this delivery time permanently.');"
