                    ...
                    <div class="page-title">
                        <ol class="text-right">
                            <li class="active"><a href="index?insert_seller_skill" class="btn btn-success">
                                    <i class="fa fa-plus-circle text-white"></i> <span class="text-white">Add New
                                        Skill</span>
                                </a></li>
                        </ol>
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="index?delete_seller_skill=<?= $skill_id; ?>"
                                            onclick="return confirm('Do you really want to delete this seller skill permanently.');"
