                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="index?approve_referral=<?= $referral_id; ?>"
                                                ...
                                                <a class="dropdown-item"
                                                    href="index?decline_referral=<?= $referral_id; ?>"
                                                    onclick="return confirm('Are you sure you want to decline this referral? if so, <?= $seller_user_name; ?> will receive no commision.');">
