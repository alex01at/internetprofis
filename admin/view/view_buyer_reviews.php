...
$start_from = ($page - 1) * $per_page;
    ...
    ?>
                    ...
                    ?>
                                    ...
                                    <td>
                                        <a href="index?delete_buyer_review=<?= $review_id; ?>"
                                            onclick="return confirm('Do You Really Want To Delete This Review After Deletion Seller Rating And His Proposal Rating Will Be Also Changed.')"
                                            class="btn btn-danger">
                                            <i class="fa fa-trash text-white"></i> <span class="text-white">Delete
                                                Review</span>
                                        </a>
                                    </td>
                                </tr>
