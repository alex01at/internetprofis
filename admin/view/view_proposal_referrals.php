                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="index?approve_proposal_referral=<?= $referral_id; ?>"
                                                    onclick="return confirm('Are you sure you want to approve this referral? if so, <?= showPrice($comission); ?>.00 will be added to <?= $seller_user_name; ?> shopping balance.');">
                                                    <i class="fa fa-thumbs-up"></i> Approve
                                                </a>
                                                <a class="dropdown-item"
                                                    href="index?decline_proposal_referral=<?= $referral_id; ?>"
                                                    onclick="return confirm('Are you sure you want to decline this referral? if so, <?= $seller_user_name; ?> will receive no commission.');">
