                        ...
                        <div class="col-lg-4 col-md-6 mb-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-footer">
                                    <!--- card-footer Starts --->
                                    <a href="index?delete_term=<?= $term_id; ?>" class="float-left btn btn-danger"
                                        title="Delete">
                                        <i class="fa fa-trash text-white"></i>
                                    </a>
                                    <a href="index?edit_term=<?= $term_id; ?>" class="float-right btn btn-success"
                                        title="Edit">
