...
?>
                                <tr>
                                    ...
                                    <td>
                                        <a title="Preview this Proposal"
                                            href="../proposals/<?= $seller_user_name; ?>/<?= $proposal_url; ?>"
                                            target="_blank">
                                            <i class="fa fa-eye"></i> Preview
                                        </a>
                                        <br>
                                        <a title="Submit this Proposal to seller for modification"
                                            href="index?submit_modification=<?= $proposal_id; ?>">
                                            <i class="fa fa-edit"></i> Submit For Modification
                                        </a>
                                        <br>
                                        <a title="Approve this Proposal"
                                            href="index?approve_proposal=<?= $proposal_id; ?>">
                                            <i class="fa fa-check-square-o"></i> Approve
                                        </a>
                                        <br>
                                        <a title="Decline this Proposal"
                                            href="index?decline_proposal=<?= $proposal_id; ?>">
