...
<div class="main-container">
    ...
    <div class="col-lg-12">
      ...
      <div class="card">
        ...
        <div class="card-header">
          ...
          <h4>Plugins</h4>
          <ol class="text-right">
            <a href="index?add_plugin" class="btn btn-success">
              <i class="text-white"></i> <span class="text-white">Add New</span>
            </a>
          </ol>
          <!-- <p class="mb-0"></p> -->
        </div>
  ...
  ?>
                <tr>
                  ...
                  <td width="150"><a href="<?= $plugin->author_url; ?>" target="_blank"
                      class="text-primary"><?= $plugin->author; ?></a></td>
                  <td>
                    <div class="dropdown">
                      <!--- dropdown Starts --->
                      ...
                      <div class="dropdown-menu" style="margin-left:-100px;">
                        ...
                        <a class="dropdown-item"
                          onclick="return confirm('Are You Sure You Want To Delete This Plugin And Its Data.')"
                          href="index?delete_plugin=<?=$plugin->id; ?>&folder=<?= $plugin->folder; ?>">
