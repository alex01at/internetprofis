        ...
        <div class="card-body">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <label class="col-md-4 control-label"> Slide Name : </label>
                    <div class="col-md-8">
                ...
                <div class="form-group row">
                    <!--- form-group row Starts --->
                    <label class="col-md-4 control-label"> Slide Description : </label>
                    <div class="col-md-8">
                ...
                <div class="form-group row">
                    <!--- form-group row Starts --->
                    <label class="col-md-4 control-label"> Slide Image/Video : </label>
                    <div class="col-md-8">
                ...
                <div class="form-group row">
                    <!--- form-group row Starts --->
                    <label class="col-md-4 control-label"> Slide Url : </label>
                    <div class="col-md-8">
