         ...
         <div class="card">
            ...
            <div class="card-header">
               ...
               <div class="float-right">
                  <div class="page-title">
                     <ol class="text-right">
                        <a href="index?view_currencies" class="btn btn-danger">
            ...
            <div class="card-body">
               ...
               <form action="" method="post" enctype="multipart/form-data">
                     ...
                     <div class="col-md-6">
                        ...
                        <small class="text-muted">
                           ...
                           <a class="text-primary"
                              href="https://www2.1010data.com/documentationcenter/prod/1010dataReferenceManual/DataTypesAndFormats/currencyUnitCodes.html"
                              target="_blank">Here</a>. For example, USA Currency ISO Code Is : USD
                        </small>
                     </div>
                  </div>
                  <!--- form-group row Ends --->
                  ...
                  <!--- form-group row Ends --->
                  <div class="form-group row d-none" required="">
                     <!--- form-group row Starts --->
                     <label class="col-md-3 control-label"> Exchange Rate : </label>
                     <div class="col-md-6">
                        <input type="text" class="form-control" name="rate"
                           placeholder="Write Currency Conversion Rate" />
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-md-6">
                        <input type="submit" name="insert" class="btn btn-success form-control"
                           value="Insert Currency" />
                     </div>
                  </div>
                  <!--- form-group row Ends --->
               </form>
