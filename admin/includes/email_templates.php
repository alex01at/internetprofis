        ...
        <div class="card mb-5">
          ...
          <div class="card-header">
            ...
            <ul class="nav nav-tabs card-header-tabs">
              ...
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#dusupay-order-completed">Coinpayments/Dusupay Completed
                  Order Email</a>
              </li>
          ...
          <div class="card-body tab-content">
            ...
            <div class="tab-pane fade show active" id="forgot">
              <!--- tab-pane fade show active Starts --->
            ...
            <div class="tab-pane fade" id="email-confirmation">
            ...
            <div class="tab-pane fade" id="inbox-new-message">
              <!--- tab-pane fade Starts --->
            ...
            <div class="tab-pane fade" id="customer-support">
              <!--- tab-pane fade Starts --->
            ...
            <div class="tab-pane fade" id="ticket-closed">
              <!--- tab-pane fade Starts --->
            ...
            <div class="tab-pane fade" id="ticket-reply">
              <!--- tab-pane fade Starts --->
            ...
            <div class="tab-pane fade" id="order-receipt">
              <!--- tab-pane fade Starts --->
            ...
            <div class="tab-pane fade" id="order-email">
              <!--- tab-pane fade Starts --->
            ...
            <div class="tab-pane fade" id="dusupay-order">
              <!--- tab-pane fade Starts --->
            ...
            <div class="tab-pane fade" id="dusupay-order-completed">
              <!--- tab-pane fade Starts --->
            ...
            <div class="tab-pane fade" id="order-delivered">
              <!--- tab-pane fade Starts --->
            ...
            <div class="tab-pane fade" id="revision_requested">
              <!--- tab-pane fade Starts --->
            ...
            <div class="tab-pane fade" id="order_cancel_seller">
              <!--- tab-pane fade Starts --->
            ...
            <div class="tab-pane fade" id="order_cancel_buyer">
              <!--- tab-pane fade Starts --->
            ...
            <div class="tab-pane fade" id="proposal-modification">
              <!--- tab-pane fade Starts --->
            ...
            <div class="tab-pane fade" id="proposal-declined">
              <!--- tab-pane fade Starts --->
            ...
            <div class="tab-pane fade" id="proposal-approved">
              <!--- tab-pane fade Starts --->
            ...
            <div class="tab-pane fade" id="admin-reset-pass">
              <!--- tab-pane fade Starts --->
            ...
            <div class="tab-pane fade" id="ban-seller">
              <!--- tab-pane fade Starts --->
            ...
            <div class="tab-pane fade" id="cancellation-request">
              <!--- tab-pane fade Starts --->
