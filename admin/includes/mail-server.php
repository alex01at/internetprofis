        ...
        <div class="card-body">
            ...
            <form action="" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <select name="library" class="form-control">
                            ...
                            <option value="swift_mailer" <?= ($library == "swift_mailer")?"selected":""; ?>> Swift
                                Mailer </option>
                        </select>
                        <small class="text-muted">If you select <b>Swift Mailer</b>, you need to enable SMTP also for it
                            to work.</small>
                    </div>
                </div>
                <!--- form-group row Ends --->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="submit" name="update_settings" class="btn btn-success form-control"
