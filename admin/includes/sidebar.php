...
<?php } ?>
<?php if(isset($_SESSION['demo_action_blocked'])): ?>
<script>
    $(document).ready(function(){
        swal({
            type: 'info',
            title: 'Demo-Modus',
            text: 'In der Demo-Version können keine Daten gespeichert, geändert oder gelöscht werden.',
...
<?php 
    unset($_SESSION['demo_action_blocked']); 
endif; 
?>