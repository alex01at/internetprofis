...
$protected_routes = [
    ...
    'a_settings' => [
        ...
        'move_layout_block'   => 'move_layout_block.php',
        'toggle_layout_block' => 'toggle_layout_block.php',
        'insert_layout_block' => 'insert_layout_block.php',
        'delete_layout_block' => 'delete/delete_layout_block.php',
