		...
		<div class="col-lg-12">
			...
			<div class="card">
				...
				<div class="card-header">
					<!--- card-header Starts --->
					<ol class="text-right">
						<a href="index?sales" class="btn btn-success">
							<i class="text-white"></i> <span class="text-white">Sales</span>
						</a>
					</ol>
						...
						<form action="" method="get">
							...
							<div class="input-group mb-3 mt-3 mt-lg-0">
								<input type="date" name="from"
									value="<?= (isset($_GET['from']))?$input->get('from'):''; ?>"
									max="<?= date("Y-m-d") ?>" class="form-control" placeholder="Search Sellers">
								...
								<tr>
									...
									<td>
										<a class="btn btn-primary text-white"
											href="index?delete_expense=<?=$expense->id; ?>">
