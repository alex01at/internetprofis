        ...
        <div class="col-lg-12">
                ...
                <div class="card-body">
                    ...
                    <form id="status" class="collapse form-inline" method="post">
                        ...
                        <p class="text-muted mb-3">
                            <span class="text-danger">Note : </span> If you solve this issue, change the text from
                            "OPEN" to "CLOSE". By doing this, this ticket will disappear.
                        </p>
                        <div class="form-group">
                            <!--- form-group Starts --->
                            <label class="mb-2 mr-sm-2 mb-sm-0"> Change Status : </label>
                            <input type="text" name="status" class="form-control mb-2 mr-sm-2 mb-sm-0"
                                value="<?= $status; ?>">
                            <input type="submit" name="update_status" class="form-control btn btn-success"
                                value="Change Status">
                        </div>
                        <!--- form-group Ends --->
                        <?php
            ...
            ?>
                    <div class="message-div mb-3">
                        <img class="message-image img-fluid img-rounded" src="<?= $sender_image; ?>" width="60"
                            height="60">
                ...
                <div class="card-body">
                    ...
                    <form id="new_message" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <textarea placeholder="Enter Your message" class="form-control" name="new_message"
                                id="new_message" rows="5"></textarea>
                        </div>
                        <!--- form-group Ends --->
                        <div class="form-group">
