...
?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="../<?= $reporter_user_name; ?>" target="_blank"
                                            class="text-success"><?= $reporter_user_name; ?></a>
                                    </td>
                                    <td>
                                        <a href="index?single_inbox_message=<?= $content_id; ?>" target="_blank"
                                            class="text-success">View Message</a>
                                    </td>
                                    <td>
                                        <?= $reason; ?>
                                    </td>
