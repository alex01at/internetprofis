...
<h5><i class="fa fa-clock-o"></i> &nbsp; <?= $delivery_proposal_title; ?> <?=$lang["sidebar"]["delivery_time"];?></h5>
...
<a href="#" data-toggle="modal" data-target="#login-modal" class="btn btn-order">
	<strong><?= $lang['proposal']['nav']['order_now']?> (<?= showPrice($proposal_price,"total-price"); ?>)</strong>
</a>
<?php 
	if($count_extras > 0){ 
		include('extras.php'); 
