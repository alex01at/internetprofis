<section class="seller-info"><!--- seller-info Starts --->
	...
	<a href="../../conversations/message?seller_id=<?= $proposal_seller_id; ?>" class="btn-standard rf"><?= $lang["user_home"]['contact'];?></a>
	...
	<a href="#!" class="see-more"><?= $lang["see_more"]; ?> </a>
	</header><!--- header Ends --->
	...
	<span><i class="fa fa-check pr-1"></i> <?= $lang["from"];?></span>
	</li>
	<li>
	<div>
	<?php
	...
	<?php } ?>
	</div> <span><i class="fa fa-check pr-1"></i> <?= $lang["speaks"];?></span>
	</li>
	<li>
	<div><?= $proposal_seller_rating; ?>%</div>
	<span><i class="fa fa-check pr-1"></i> <?= $lang["dashboard"]['positive_rating'];?></span>
	</li>
	<li>
	<div><?= $proposal_seller_recent_delivery; ?></div>
	<span><i class="fa fa-check pr-1"></i> <?= $lang["dashboard"]['recent_delivery'];?> </span>
	</li>
	</ul>
