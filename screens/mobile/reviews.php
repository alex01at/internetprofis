...
<?php if($proposal_price == 0){ ?>
    ...
    <tr>
      <td class="b-ccc"> <?=$lang['order_details']['revisions'];?> </td>
      <td><?= ucwords($p_revisions_1); ?></td>
      <td><?= ucwords($p_revisions_2); ?></td>
      <td><?= ucwords($p_revisions_3); ?></td>
    </tr>
    <tr>
      <td class="b-ccc"> <?= $lang["sidebar"]["delivery_time"];?> </td>
...
<header><h2> <?= $lang['proposal']['reviews'];?><small>
...
<select>
<option class="js-gtm-event-auto" value="all"><?=$lang['proposal']['most_recent'];?></option>
<option class="js-gtm-event-auto" value="good"><?= $lang['proposal']['positive_reviews'];?></option>
<option class="js-gtm-event-auto" value="bad"><?=$lang['proposal']['negative_reviews'];?></option>
</select>
</div>
</header>
