<form action="../../checkout" id="checkoutForm" method="post">
  ...
  <div class="header">
    <span class="text <?=($lang_dir == "right" ? 'text-right':'')?>">
      <span class="dropdown" tabindex="0" data-toggle="popover" data-placement="bottom" data-html="true" data-content="<?php include('orderDetailsPopover.php'); ?>"><?=$lang['order_details']['desc'];?></span>
  ...
  <div class="row">
    <div class="col-12 ml-2 p-2">
      <h6 class="mb-0 <?=($lang_dir == "right" ? 'text-right pr-4':'')?>">
        <i class="fa fa-clock-o"></i> <?= $delivery_proposal_title;  ?>&nbsp;<?=  $lang["sidebar"]["delivery_time"]; ?> 
        &nbsp;&nbsp;
